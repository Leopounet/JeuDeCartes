...
/**
 * @brief Cette structure de donnée doit représenter
 * un jeu de carte pouvant contenir au maximum
 * MAX_DECK_SIZE (52) cartes, cependant le 
 * jeu de carte peut contenir moins de cartes.
 * Il faut donc stocker les cartes dans une structure
 * de données adéquate, et il faut aussi savoir à tout
 * moment combien de cartes sont dans le jeu de cartes.
 *
 * On suppose qu'un jeu de cartes est ordonné, c'est-à-dire
 * qu'il est possible de récupérer la carte à l'index '0',
 * à l'index '1', ... voir la fonction 'get_index' plus bas.
 */
typedef struct Deck {
